                ...
                <View style={styles.formContainer}>
                  <View>
                    <View style={getEmailInputStyle()}>
                      ...
                      {email && (
                        emailError ? 
                          <AlertCircle color="#EF4444" size={18} style={styles.fieldStatus} /> :
                          emailValid && <CheckCircle color="#22C55E" size={18} style={styles.fieldStatus} />
                      )}
                    </View>
                  ...
                  <TouchableOpacity style={[styles.authButton, (!isFormValid || loading) && styles.authButtonDisabled]} onPress={handleLogin} disabled={loading || !isFormValid} activeOpacity={0.8}>
                    <LinearGradient colors={loading ? ['#94A3B8', '#64748B'] : isFormValid ? ['#3B82F6', '#2563EB'] : ['#64748B', '#475569']} style={styles.authGradient}>
                      {loading ? <ActivityIndicator color="#FFFFFF" /> : <Text style={styles.authButtonText}>Sign In</Text>}
                    </LinearGradient>
                  </TouchableOpacity>

                  <TouchableOpacity style={styles.toggleButton} onPress={() => router.push('/(auth)/signup')} disabled={loading} activeOpacity={0.7}>
                  ...
                  <TouchableOpacity style={styles.googleButton} onPress={handleGoogleLogin} disabled={loading} activeOpacity={0.8}>
