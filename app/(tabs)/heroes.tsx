...
const styles = StyleSheet.create({
  ...
  heroCard: { width: (width - 42) / 2, height: 190, backgroundColor: 'rgba(30, 41, 59, 0.8)', borderRadius: 14, overflow: 'hidden', borderWidth: 2 },
  ...
  mysteryCard: { width: (width - 42) / 2, height: 190, borderRadius: 14, overflow: 'hidden', borderWidth: 2, borderColor: '#FBBF24', backgroundColor: '#0F172A' },
